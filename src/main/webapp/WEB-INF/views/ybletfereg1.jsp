...
<!-- nice css & js -->
    <link rel="stylesheet" href="resources/css/ybnicepage.css" media="screen">
<link rel="stylesheet" href="resources/css/ybLetfe_reg1.css" media="screen">
    <script class="u-script" type="text/javascript" src="resources/js/ybjquery.js" "="" defer=""></script>
    <script class="u-script" type="text/javascript" src="resources/js/ybnicepage.js" "="" defer=""></script>
...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
	...
	<section class="hero-wrap hero-wrap-2"
	 ...
	 <section class="u-clearfix u-section-1" id="carousel_8dbd">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-expanded-width u-image u-image-default u-image-1" src="resources/images/ybletfe1.jpg" alt="" data-image-width="1920" data-image-height="1280">
        <div class="u-container-style u-group u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h4 class="u-custom-font u-font-montserrat u-text u-text-1">축제 분류 지정&nbsp;</h4>
              ...
              <form action="//publish.nicepage.com/Form/Process" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 0px;">
                ...
                <div class="u-form-group u-form-select u-form-group-2">
                  ...
                  <div class="u-form-select-wrapper">
                    <select id="select-0e5b" name="select" class="u-border-2 u-border-grey-5 u-grey-5 u-input u-input-rectangle u-radius-10">
                ...
                <div class="u-form-group u-form-select u-form-group-3">
                  ...
                  <div class="u-form-select-wrapper">
                    <select id="select-6510" name="select-2" class="u-border-2 u-border-grey-5 u-grey-5 u-input u-input-rectangle u-radius-10">
                      <option value="Item 1">Item 1</option>
                      <option value="Item 2">Item 2</option>
                      <option value="Item 3">Item 3</option>
                    </select>
